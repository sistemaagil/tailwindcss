...
import { FalconSocialFeedComponent } from './falcon/falcon-social-feed/falcon-social-feed.component';
import { EditorExampleComponent } from './falcon/editor-example/editor-example.component';
...
import { FalconProductDetailsCINCOCINCOComponent } from './falcon/e-commerce/falcon-product-details-cinco-cinco/falcon-product-details-cinco-cinco.component';
...
@NgModule({
  declarations: [
    ...
    FalconProductDetailsCINCOCINCOComponent,
  ],
  imports: [
    CommonModule,
