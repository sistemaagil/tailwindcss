...
@Component({
  ...
  templateUrl: './falcon-crm-new-contact.component.html',
  styleUrls: ['./falcon-crm-new-contact.component.css']
})
export class FalconCrmNewContactComponent implements OnInit {
